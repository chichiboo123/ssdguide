    ...
    <div className="min-h-[calc(100vh-56px)]">
      ...
      <section className="hero-gradient relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 pt-16 pb-20 md:pt-24 md:pb-28 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white leading-snug mb-4 animate-fade-in-up" style={{lineHeight: "1.45"}}>
            성취기준,
            <br />
            수업을 함께 디자인하는 동료
          </h1>
              ...
              {displayCount < filteredData.length && (
                <div className="flex justify-center mt-6">
                  ...
                  >
                    ...
                    더 보기 ({filteredData.length - displayCount}개 남음)
                  </Button>
                </div>
              )}
            </>
      ...
      <div className="lg:hidden fixed bottom-6 right-4 z-30">
        <Button
          ...
          className="rounded-2xl shadow-xl h-14 w-14 bg-primary hover:bg-primary/90 relative"
          size="icon"
        >
      ...
      <Dialog open={showClearDialog} onOpenChange={setShowClearDialog}>
        <DialogContent className="sm:rounded-2xl">
          ...
          <div className="flex justify-end gap-2 mt-4">
            <Button variant="outline" onClick={() => setShowClearDialog(false)} className="rounded-xl">취소</Button>
            <Button
              variant="destructive"
              className="rounded-xl"
              onClick={() => {
